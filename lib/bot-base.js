...
class BotBase {
  ...
  onChat(username, message) {
    ...
    // Listen for Isabella's zone clearing assignments
    ...
    if (zoneMatch && username === 'isabella') {
  ...
  async handleZoneClearingAssignment(x, y, z, radius) {
    ...
    try {
      ...
      this.logger.info(`Found ${blocks.length} blocks to clear in assigned zone`)
      ...
      this.bot.chat(`My zone is clear, Isabella!`)
    } catch (error) {
